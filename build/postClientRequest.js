...
let postClientRequestAjv = null;
function postClientRequestValidator() {
    if (postClientRequestAjv == null) {
        postClientRequestAjv = new Ajv({ validateSchema: false }).compile(exports.postClientRequestSchema);
    }
    return postClientRequestAjv;
}
exports.postClientRequestValidator = postClientRequestValidator;
//# sourceMappingURL=postClientRequest.js.map