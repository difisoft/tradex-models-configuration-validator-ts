...
exports.openApiFileRequestSchema = {
    ...
    "description": "openApiFileRequest schema",
    "type": "object",
    "allOf": [
        {
...
let openApiFileRequestAjv = null;
function openApiFileRequestValidator() {
    if (openApiFileRequestAjv == null) {
        openApiFileRequestAjv = new Ajv({ validateSchema: false }).compile(exports.openApiFileRequestSchema);
    }
    return openApiFileRequestAjv;
}
exports.openApiFileRequestValidator = openApiFileRequestValidator;
//# sourceMappingURL=openApiFileRequest.js.map