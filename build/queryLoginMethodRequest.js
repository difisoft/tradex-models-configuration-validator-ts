...
let queryLoginMethodRequestAjv = null;
function queryLoginMethodRequestValidator() {
    if (queryLoginMethodRequestAjv == null) {
        queryLoginMethodRequestAjv = new Ajv({ validateSchema: false }).compile(exports.queryLoginMethodRequestSchema);
    }
    return queryLoginMethodRequestAjv;
}
exports.queryLoginMethodRequestValidator = queryLoginMethodRequestValidator;
//# sourceMappingURL=queryLoginMethodRequest.js.map