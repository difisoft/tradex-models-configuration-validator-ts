    ...
    "allOf": [
        ...
        },
        {
            "properties": {
                ...
                "forwardType": {
                    "description": "filter by forwardType",
                    "type": "string"
                },
                "scopeGroupId": {
                    "description": "filter by scope group id",
                    "type": "integer"
                },
                "lastSequence": {
...
let queryAdminScopeRequestAjv = null;
function queryAdminScopeRequestValidator() {
    if (queryAdminScopeRequestAjv == null) {
        queryAdminScopeRequestAjv = new Ajv({ validateSchema: false }).compile(exports.queryAdminScopeRequestSchema);
    }
    return queryAdminScopeRequestAjv;
}
exports.queryAdminScopeRequestValidator = queryAdminScopeRequestValidator;
//# sourceMappingURL=queryAdminScopeRequest.js.map