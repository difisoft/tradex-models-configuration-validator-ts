...
exports.clientResponseValidator = exports.clientResponseSchema = void 0;
...
function clientResponseValidator() {
    if (clientResponseAjv == null) {
        clientResponseAjv = new Ajv({ validateSchema: false }).compile(exports.clientResponseSchema);
    }
    return clientResponseAjv;
}
exports.clientResponseValidator = clientResponseValidator;
