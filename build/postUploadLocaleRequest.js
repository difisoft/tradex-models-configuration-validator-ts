...
function postUploadLocaleRequestValidator() {
    if (postUploadLocaleRequestAjv == null) {
        postUploadLocaleRequestAjv = new Ajv({ validateSchema: false }).compile(exports.postUploadLocaleRequestSchema);
    }
    return postUploadLocaleRequestAjv;
}
exports.postUploadLocaleRequestValidator = postUploadLocaleRequestValidator;
//# sourceMappingURL=postUploadLocaleRequest.js.map