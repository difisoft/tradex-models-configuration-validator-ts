...
export const loginMethodResponseSchema = {
...
export function loginMethodResponseValidator() {
  if (loginMethodResponseAjv == null) {
    loginMethodResponseAjv = new Ajv({validateSchema: false}).compile(loginMethodResponseSchema);
  }
