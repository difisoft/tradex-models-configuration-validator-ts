...
export const querySystemClientResponseSchema = {
...
export function querySystemClientResponseValidator() {
  if (querySystemClientResponseAjv == null) {
    querySystemClientResponseAjv = new Ajv({validateSchema: false}).compile(querySystemClientResponseSchema);
  }
