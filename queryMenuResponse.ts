...
export const queryMenuResponseSchema = {
...
export function queryMenuResponseValidator() {
  if (queryMenuResponseAjv == null) {
    queryMenuResponseAjv = new Ajv({validateSchema: false}).compile(queryMenuResponseSchema);
  }
