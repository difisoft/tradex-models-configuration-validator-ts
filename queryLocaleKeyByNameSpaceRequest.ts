...
export const queryLocaleKeyByNameSpaceRequestSchema = {
...
export function queryLocaleKeyByNameSpaceRequestValidator() {
  if (queryLocaleKeyByNameSpaceRequestAjv == null) {
    queryLocaleKeyByNameSpaceRequestAjv = new Ajv({validateSchema: false}).compile(queryLocaleKeyByNameSpaceRequestSchema);
  }
