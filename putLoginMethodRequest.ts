...
export const putLoginMethodRequestSchema = {
...
export function putLoginMethodRequestValidator() {
  if (putLoginMethodRequestAjv == null) {
    putLoginMethodRequestAjv = new Ajv({validateSchema: false}).compile(putLoginMethodRequestSchema);
  }
