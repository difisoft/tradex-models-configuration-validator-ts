...
export const querySignedDataToUploadRequestSchema = {
...
export function querySignedDataToUploadRequestValidator() {
  if (querySignedDataToUploadRequestAjv == null) {
    querySignedDataToUploadRequestAjv = new Ajv({validateSchema: false}).compile(querySignedDataToUploadRequestSchema);
  }
