...
export const openApiFileRequestSchema = {
...
export function openApiFileRequestValidator() {
  if (openApiFileRequestAjv == null) {
    openApiFileRequestAjv = new Ajv({validateSchema: false}).compile(openApiFileRequestSchema);
  }
