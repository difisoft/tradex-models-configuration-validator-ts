...
export const queryAdminScopeRequestSchema = {
...
export function queryAdminScopeRequestValidator() {
  if (queryAdminScopeRequestAjv == null) {
    queryAdminScopeRequestAjv = new Ajv({validateSchema: false}).compile(queryAdminScopeRequestSchema);
  }
