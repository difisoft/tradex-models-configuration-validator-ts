...
export const queryClientRequestSchema = {
...
export function queryClientRequestValidator() {
  if (queryClientRequestAjv == null) {
    queryClientRequestAjv = new Ajv({validateSchema: false}).compile(queryClientRequestSchema);
  }
