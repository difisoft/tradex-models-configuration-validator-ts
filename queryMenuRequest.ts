...
export const queryMenuRequestSchema = {
...
export function queryMenuRequestValidator() {
  if (queryMenuRequestAjv == null) {
    queryMenuRequestAjv = new Ajv({validateSchema: false}).compile(queryMenuRequestSchema);
  }
