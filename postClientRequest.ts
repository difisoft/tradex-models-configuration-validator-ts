...
export const postClientRequestSchema = {
...
export function postClientRequestValidator() {
  if (postClientRequestAjv == null) {
    postClientRequestAjv = new Ajv({validateSchema: false}).compile(postClientRequestSchema);
  }
